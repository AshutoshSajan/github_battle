			...
			<div className="input-box-container">
				{
					this.state.userInfo ? 
						<div className="userInfo">
							<img style={{width: "300px", borderRadius:"50%"}} alt={"Players"} src={this.state.userInfo ? this.state.userInfo.avatar_url : ""} />
							<div className="para">
							...
							<button  className="reset-btn" type="submit" onClick={()=> {this.props.handleReset(); this.handleResets()}} >Reset</button>
						</div>
					 :
						<div>
